...
<table border="0" align="center" width="300px">
    ...
    <td align="right">$  <?php echo ($reg->total_venta) - (($reg->total_venta) * .16 ) ;  ?></td>
    </tr>

     <tr>
    <td>&nbsp;</td>
    <td align="right">IVA:</td>
    <td align="right">$  <?php echo $reg->total_venta * .16;  ?></td>
    </tr>
    ...
    <tr>
      <td colspan="3" align="center">Ferreteria </td>
    </tr>
    <tr>
      <td colspan="3" align="center">Coatzacoalcos - Ver.</td>
    </tr>
