INSERT INTO db_sistema.persona (tipo_persona,nombre,tipo_documento,num_documento,direccion,telefono,email) VALUES
	 ('Proveedor','COCA-COLA','INE','LUNES MARTES','','',''),
	 ('Proveedor','BARCEL','INE','SABADO','SABADOS','',''),
	 ('Proveedor','MARINELA','INE','MARTES','','',''),
	 ('Proveedor','BIMBO','INE','JUEVES','','',''),
	 ('Proveedor','HUEVO CALVARIO','INE','','','922 157 2990',''),
	 ('Proveedor','PEÑA FIEL','INE','MARTES-MIERCOLES','','',''),
